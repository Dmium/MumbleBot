...
namespace MumbleSharp
{
    ...
    public class MumbleConnection
    {
        ...
        DateTime _lastSentPing2 = DateTime.MinValue;
        ...
        //    //This is *totally wrong*
        //    //the packet contains raw encoded voice data, but we need to put it into the proper packet format
        //    //Extensions.IEnumerableOfChannelExtensions.SendMessage(channels, sendtext, false);
        //}
        ...
        public System.Collections.Generic.IEnumerable<Model.Channel> channels { get; set; }
    }
}
